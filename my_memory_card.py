...
questions_list.append(
    Question('Presiden Pertama Indonesia', 'Soekarno', 'SBY', 'Jokowi', 'Megawati')
)
questions_list.append(
    Question('Bulan Apa Indonesia Merdeka', 'Agustus', 'September', 'Desember', 'Januari')
)
questions_list.append(
    Question('Siapa Pembaca Teks Proklamasi', 'Soekarno', 'Prabowo', 'Megawati', 'Jokowi')
)
app = QApplication([])
